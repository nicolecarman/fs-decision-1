...
if (amysAge > brittanisAge) {
  ...
  // if Brittani is older
  console.log("Brittani is older.")
} else {
  // if Amy and Brittani are the same age
...
if (temperature >= 80 && rain === true) {
  ...
  } else if (temperature > 59 && temperature < 81 && rain === true) {
...
if (temperature >= 80 && rain === false) {
  ...
  } else if (temperature > 59 && temperature < 81 && rain === false) {
